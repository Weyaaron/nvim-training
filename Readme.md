...
training.configure({ -- All of these options work for 'opts' of lazy as well.
	...
	logging_args = {
		...
		display_logs = false, --Controls wether logs should be displayed. WARNING: Enabling his produces a lot of noise, but might be usefull for developers.
		display_warnings = true, --Controls wether warnings should be displayed.
	},
