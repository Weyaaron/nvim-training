...
local lorem_ipsum = {"Lorem ipsum dolor sit amet consectetur adipisici elit",
...
nvim_buf_get_lines= function() return lorem_ipsum end
}}
...
function TestBasicListFunctions:test_w_indexes()
    local traversal_result = Movements.w(TestBasicListFunctions.root_node, 5,5, {offset=1})
